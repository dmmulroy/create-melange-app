 ...
 * larger codebases.
 *
 * In a Dune-managed project, each module corresponds to a file by default, so this
 * pattern is often used to expose certain modules at a higher level for easier access
